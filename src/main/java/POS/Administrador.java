...
public class Administrador extends javax.swing.JFrame {
    ...
    public void cambio(boolean solicitud) {
        if (solicitud) {
            pAdministrador.setBackground(Color.green);
        }else{
            pAdministrador.setBackground(Color.blue);
        }
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        pAdministrador.setBackground(new java.awt.Color(255, 255, 255));
